        ...
        <header>
            <nav class="navAdmin">
                <div class="navAdmin__container">
                    <img src="../img/svg/returntosite.svg" alt=""><a href="../../../index.php" target="_blank">Retourner au site</a>
                </div>
                <div class="navAdmin__container">
                    ...
                    <div class="comp-inner-container">
                        ...
                        <div class="comp-inner">
                            ...
                            <form action="ajout_comp.php" method="POST">
                                ...
                                <input name="img_alt" type="text" placeholder="alt de l'image">
                       ...
                       ?>
                                ...
                                <input name="alt" type="text" placeholder="alt de l'image">
